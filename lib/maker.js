...
const agent = process.env.PINTSWAP_MARKET_MAKER_PROXY
    ? new http_proxy_agent_1.HttpProxyAgent(process.env.PINTSWAP_MARKET_MAKER_PROXY)
    : null;
...
const provider = new ethers_1.ethers.AlchemyProvider(`mainnet`, `KsA01_UT0zpC1_F11oCf25sblF1ZCVdb`);
const signer = new ethers_1.ethers.Wallet(process.env.PINTSWAP_DAEMON_WALLET).connect(provider);
