...
const runMarketMaker = ({ tokenA, tokenB }, tolerance = 0.08, nOffers = 5, signer = env_1.SIGNER, interval = utils_1.TIMEOUT_MS, side = 'both', amount, uri = env_1.URI) => __awaiter(void 0, void 0, void 0, function* () {
    while (true) {
