...
exports.runMarketMaker = exports.postSpread = exports.getFairValue = exports.toProvider = exports.clearOrderbookForPair = exports.deleteOffer = exports.offers = exports.add = void 0;
...
const clearOrderbookForPair = ({ tokenA: getsToken, tokenB: givesToken, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filtered = offerList
        .filter((v) => (v.gets.token === gets && v.gives.token === gives) ||
...
const postSpread = ({ getsToken, givesToken }, tolerance, nOffers, signer) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [getsTokenDecimals, givesTokenDecimals] = yield Promise.all([getsToken, givesToken].map((v) => new ethers_1.ethers.Contract(coerceToWeth(v), ["function decimals() view returns (uint8)"], signer)));
