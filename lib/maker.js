...
function publishOnce() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield fetch(env_1.URI + "/publish-once", {
            method: "POST",
            body: JSON.stringify({}),
            headers: {
                "content-type": "application/json",
...
const postSpread = ({ getsToken, givesToken }, tolerance = 0.08, nOffers = 5, signer = env_1.SIGNER, amount) => __awaiter(void 0, void 0, void 0, function* () {
...
const runMarketMaker = ({ tokenA, tokenB }, tolerance = 0.08, nOffers = 5, interval = utils_1.TIMEOUT_MS, side = 'both', amount) => __awaiter(void 0, void 0, void 0, function* () {
    while (true) {
        yield (0, exports.clearOrderbookForPair)({ tokenA, tokenB });
        if (side === 'buy' || side === 'both') {
            yield (0, exports.postSpread)({ getsToken: tokenA, givesToken: tokenB }, tolerance, nOffers, env_1.SIGNER, amount);
        }
        if (side === 'sell' || side === 'both') {
            yield (0, exports.postSpread)({ getsToken: tokenB, givesToken: tokenA }, tolerance, nOffers, env_1.SIGNER, amount);
        }
        yield publishOnce();
