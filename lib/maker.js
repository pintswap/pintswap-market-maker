...
exports.MarketMaker = exports.postSpread = exports.getFairValue = exports.clearOrderbookForPair = exports.deleteOffer = exports.offers = exports.add = void 0;
...
class MarketMaker {
    ...
    staticDca({ tokenA, tokenB }, tolerance = 0.08, nOffers = 5, signer = env_1.SIGNER, side = 'both', amount) {
        return __awaiter(this, void 0, void 0, function* () {
