...
exports.MarketMaker = exports.ensureChainId = exports.postStaticSpread = exports.postSpread = exports.getFairValue = exports.clearOrderbookForPair = exports.deleteOffer = exports.offers = exports.add = void 0;
...
function ensureChainId(chainId, signer) {
    return __awaiter(this, void 0, void 0, function* () {
        // Ensure chain id is correct
        const network = yield signer.provider.getNetwork();
        if (chainId !== 1 || network.chainId !== BigInt(chainId)) {
            signer.connect((0, sdk_1.providerFromChainId)(chainId));
        }
        // Set class var
        this.chainId = chainId;
    });
}
exports.ensureChainId = ensureChainId;
class MarketMaker {
    constructor({ uri = env_1.URI, isStarted = false, chainId = 1, }) {
        Object.assign(this, {
            uri,
            isStarted,
            chainId
    ...
    staticDca({ tokens, startPriceInUsd, tolerance = 0.08, nOffers = 5, signer = env_1.SIGNER, side = 'both', amount, chainId }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tokenA, tokenB } = tokens;
            this.dcaTokenA = tokenA;
            this.dcaTokenB = tokenB;
            yield ensureChainId(chainId, signer);
    ...
    runMarketMaker({ tokens, tolerance = 0.08, nOffers = 5, signer = env_1.SIGNER, interval = utils_1.TIMEOUT_MS, side = 'both', amount, chainId }) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check if started
            if (this.isStarted) {
